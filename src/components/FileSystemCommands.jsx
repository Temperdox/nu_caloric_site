...
import { fileSystem } from './terminal/data/FileSystemData';
import { resolvePath, getObjectAtPath, isDirectory, pathExists } from './terminal/utils/FileSystemUtils';
...
const FileSystemCommands = {
    ...
    executeCommand(command, args, terminalState) {
        ...
        switch (command) {
            ...
            case 'pwd':
                ...
                break;
            case 'cat':
                this.displayFile(args, currentDirectory, history, setHistory, onNavigate);
                break;
            case 'nano':
     ...
     */
    displayFile(args, currentDirectory, history, setHistory, onNavigate) {
        if (args.length === 0) {
            setHistory([
                ...history,
        ...
        // Handle special case for burger animation
        if (args[0] === 'on_burger') {
            return {
                command: 'burger',
                args: []
